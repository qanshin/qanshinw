...
<head>
    ...
    <title>Քանշին | Շինարարություն և Վերանորոգում</title>
...
<body>
	...
	<section class="top_header_area">
	    <div class="container">
            <ul class="nav navbar-nav top_nav">
                <li><a href="#"><i class="fa fa-phone"></i>+373 93 268 925</a></li>
                <li><a href="#"><i class="fa fa-envelope-o"></i>qanshin.info@gmail.com</a></li>
                <li><a href="#"><i class="fa fa-clock-o"></i>Երկ - Ուրբ 9:00 - 20:00</a></li>
            </ul>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown submenu">
                            ...
                            <ul class="dropdown-menu other_dropdwn">
                                <li><a href="renovation.html">Տան Վերանորոգում</a></li>
                                <li><a href="service.html">Տուն Սերվիս</a></li>
                                <li><a href="design.html">Դիզայներական Ծառայություններ</a></li>
                            </ul>
                        </li>
                        <li class="dropdown submenu">
        ...
        <div class="slider_inner">
            <div data-thumb="images/slider-1.jpg" data-src="images/slider-1.jpg">
                <div class="camera_caption">
                   <div class="container">
                        <h5 class=" wow fadeInUp animated">Կապիտալ Վերանորոգում</h5>
                        <p class=" wow fadeInUp animated" data-wow-delay="0.8s">Մեր ընկերությունը իրականացնում է ցանկացած կառույցի կապիտալ և հիմնանորոգման աշխատանքներ։ Աշպատանքի բարձր որակը երաշխավորվում է</p>
                        <a class=" wow fadeInUp animated" data-wow-delay="1s" href="#">Կարդալ Ավելին</a>
                   </div>
                </div>
            </div>
            <div data-thumb="images/slider-2.jpg" data-src="images/slider-2.jpg">
                <div class="camera_caption">
                   <div class="container">
                        <h5 class=" wow fadeInUp animated">Տուն Սերվիս</h5>
                        <p class=" wow fadeInUp animated" data-wow-delay="0.8s">Ցանկացած տեսակի և ցանկացած բարդության սանտեխնիկական աշխատանքներ։ Մեր մասնագետները սիրով կմոտենան, տեղում կդիտարկեն, կչափագրեն և այնուհետ մասնագիտորոն կվերացնեն առկա խնդիրը լավագույն լուծումներով</p>
                        <a class=" wow fadeInUp animated" data-wow-delay="1s" href="#">Կարդալ Ավելին</a>
                   </div>
                </div>
            </div>
        ...
        <div class="container">
           <div class="row builder_all">
                <div class="col-md-3 col-sm-6 builder">
                    ...
                    <h4>Պրոֆեսսիոնալ Անձնակազմ</h4>
                    <p>Մեր կազմակերպության աշխատակիցները ունեն տասնյակ տարիների փորձառություն</p>
                </div>
                <div class="col-md-3 col-sm-6 builder">
                    <i class="fa fa-building" aria-hidden="true"></i>
                    <h4>Բարձր Որակ</h4>
                    <p>Մեր կողմից կատարված աշխատանքի որակը երաշխավորվում է</p>
                </div>
                <div class="col-md-3 col-sm-6 builder">
                    <i class="fa fa-clock-o" aria-hidden="true"></i>
                    <h4>Մշտապես Ժամանակին</h4>
                    <p>Աշխատանքները հանձնվում են ժամանակին</p>
                </div>
                <div class="col-md-3 col-sm-6 builder">
                    <i class="fa fa-thumbs-up" aria-hidden="true"></i>
                    <h4>Մատչելի Գներ</h4>
                    <p>Մեր ծառայությունները մատուցվում են մատչելի գներով</p>
                </div>
           </div>
        </div>
    </section>
    ...
    <section class="what_we_area row">
        <div class="container">
            <div class="tittle wow fadeInUp">
                ...
                <h4>Մենք առաջարկում ենք բազում շինարարական և դիզայներական ծառայություններ</h4>
            </div>
            <div class="row construction_iner">
                <div class="col-md-4 col-sm-6 construction">
                   ...
                   <div class="cns-content">
                        <i class="fa fa-home" aria-hidden="true"></i>
                        <a href="#">Կապիտալ Վերանորոգում</a>
                        <p>Վստահեք ձեր տան կամ գրասենյակի կապիտալ վերանորոգումը մեր բարձրակարգ մասնագետներին</p>
                   </div>
                </div>
                <div class="col-md-4 col-sm-6 construction">
                   <div class="cns-img">
                   ...
                   <div class="cns-content">
                        ...
                        <a href="#">Տուն Սերվիս</a>
                        <p>Ունե՞ք սանտեխնիկական ծառայությունների կարիք։ Մեր մասնագետները կչափագրեն և կվերացնեն առկա խնդիրները</p>
                   </div>
                </div>
                <div class="col-md-4 col-sm-6 construction">
                   <div class="cns-img">
                   ...
                   <div class="cns-content">
                        ...
                        <a href="#">Դիզայն</a>
                        <p>Մեր մասնագետները նաև տրամադրում են բարծրակարգ ինտերիոր և գծագրական դիզայնի ծառայություններ</p>
                   </div>
                </div>
            </div>
        </div>
    ...
    <footer class="footer_area">
        <div class="container">
            <div class="footer_row row">
                <div class="col-md-3 col-sm-6 footer_about">
                    ...
                    <p>Մատչելի և որակյալ շինարարական և դիզայներական ծառայություններ</p>
                ...
                <div class="col-md-3 col-sm-6 footer_about quick">
                    <h2>ՄԵՆՅՈՒ</h2>
                    <ul class="quick_link">
                        <li><a href="#"><i class="fa fa-chevron-right"></i>Տան Վերանորոգում</a></li>
                        <li><a href="#"><i class="fa fa-chevron-right"></i>Տուն Սերվիս</a><
                        <li><a href="#"><i class="fa fa-chevron-right"></i>Դիզայն</a></li>
                        <li><a href="#"><i class="fa fa-chevron-right"></i>Գործընկեր</a></li>
                        <li><a href="#"><i class="fa fa-chevron-right"></i>Մեր Մասին</a></li>
                        <li><a href="#"><i class="fa fa-chevron-right"></i>Հետադարծ Կապ</a></li>
                    </ul>
                </div>
                <div class="col-md-3 col-sm-6 footer_about">
                    <h2>ԿԱՊՆՎԵՔ ՄԵԶ ՀԵՏ</h2>
                    <address>
                        <p>Հարցերի և համագործակցելու համար կարող եք կապնվել մեզ հետ</p>
                        <ul class="my_address">
                            <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i>info@qanshin.am</a></li>
                            <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i>+374 93 268 925</a></li>
        ...
        <div class="copyright_area">
            2018 Քանշին ՍՊԸ. © Բոլոր իրավունքները պաշտպանված են</a>
        </div>
    </footer>
    <!-- End Footer Area -->
